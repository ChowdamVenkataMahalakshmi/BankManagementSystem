...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        JLabel pindetail = new JLabel("Your 4 Digit Passward");
        ...
        c7 = new JCheckBox("I hereby declares that the above entired details are correct to the best of my knowledge");
